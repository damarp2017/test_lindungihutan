...
<div class="container-fluid bg-light min-vh-100 ww-100">
    <div class="p-5">
        ...
        <form action="{{ route('negara.update', $data->kd_negara) }}" method="post">
            @csrf
            @method('PUT')
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('kd_negara') is-invalid @enderror" id="kd_negara"
                            name="kd_negara" required value="{{ old('kd_negara', $data->kd_negara) }}">
                        @error('kd_negara')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nm_negara') is-invalid @enderror" id="nm_negara"
                            name="nm_negara" required value="{{ old('nm_negara', $data->nm_negara) }}">
                        @error('nm_negara')
                        <div class="text-danger fs-sm">
                            <small>{{ $message }}</small>
                        </div>
