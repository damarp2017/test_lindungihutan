...
<div class="container-fluid bg-light min-vh-100 ww-100">
    <div class="p-5">
        ...
        <form action="{{ route('film.update', $data->kd_film) }}" method="post">
            @csrf
            @method('PUT')
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nm_film') is-invalid @enderror" id="nm_film"
                            name="nm_film" required value="{{ old('nm_film', $data->nm_film) }}">
                        @error('nm_film')
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="genre" name="genre" required>
                            ...
                            <option @if (old('genre', $data->genre)==$item->kd_genre) selected @endif value="{{
                                $item->kd_genre
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="artis" name="artis" required>
                            ...
                            <option @if (old('artis', $data->artis)==$item->kd_artis) selected @endif value="{{
                                $item->kd_artis
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="produser" name="produser" required>
                            ...
                            <option @if (old('produser', $data->produser)==$item->kd_produser) selected @endif value="{{
                                $item->kd_produser
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('pendapatan') is-invalid @enderror"
                            id="pendapatan" name="pendapatan" required
                            value="{{ old('pendapatan', $data->pendapatan) }}">
                        @error('pendapatan')
                        <div class="text-danger fs-sm">
                            <small>{{ $message }}</small>
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('nominasi') is-invalid @enderror" id="nominasi"
                            name="nominasi" required value="{{ old('nominasi', $data->nominasi) }}">
                        @error('nominasi')
                        <div class="text-danger fs-sm">
                            <small>{{ $message }}</small>
                        </div>
